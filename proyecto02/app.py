...
class Docente(db.Model):
    ...
    año = db.Column(db.String(200))
    costo = db.Column(db.String(200), nullable=False) # este atributo no puede ser nulo


    def __repr__(self):
        return "Matricila: nombre=%s placa=%s año:%s costo:%s" % (
                          self.nombre,
                          self.placa,
                          self.año,
                          self.costo)
